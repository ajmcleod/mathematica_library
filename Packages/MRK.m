...
(*irreducibleFunctionsToEMRK = {H3[a_] :> EMRK[H3[a]], H4[a_] :> EMRK[H4[a]], H5[a_] :> EMRK[H5[a]], H6[a_] :> EMRK[H6[a]], H7[a_] :> EMRK[H7[a]], H8[a_] :> EMRK[H8[a]], H9[a_] :> EMRK[H9[a]], H10[a_] :> EMRK[H10[a]], Subscript[OverTilde[\[CapitalPhi]],6]:>EMRK[Subscript[OverTilde[\[CapitalPhi]],6]], Superscript[\[CapitalOmega], "(2)"][a_,b_,c_]:> EMRK[Superscript[\[CapitalOmega], "(2)"][a,b,c]], Subscript[F, 1][s_,b_,c_]:>EMRK[Subscript[F, 1][s,b,c]],Subscript[H, 1][s_,b_,c_]:>EMRK[Subscript[H, 1][s,b,c]], Subscript[J, 1][s_,b_,c_]:>EMRK[Subscript[J, 1][s,b,c]],N :>EMRK[N], O :> EMRK[O],  Subscript[M, 1][s_,b_,c_]:>EMRK[Subscript[M, 1][s,b,c]], Subscript[Q, "ep"][a_, b_, c_] :> EMRK[Subscript[Q, "ep"][a, b, c]], G :> EMRK[G], Subscript[K, 1][a_, b_, c_]:>EMRK[Subscript[K, 1][a, b, c]]};*)
...
(*toEMRKlimit[func_]:=Expand[func/.irreducibleFunctionsToEMRK/.SVHPLreplacements/.{Log[\[Xi]]->HPL[{0},\[Xi]]}/.toHPL/.{u->1-\[Xi]}/.flipArgument[{1-v,1-w,1-\[Xi]}]/.HPL[{___,1},Alternatives[\[Xi],v,w]]->0/.{HPL[{0},\[Xi]]->Log[\[Xi]], HPL[{0},v]->Log[\[Xi]]+HPL[{1},z]+HPL[{1},zb], HPL[{0},w]->Log[\[Xi]]+HPL[{0},z]+HPL[{0},zb]+HPL[{1},z]+HPL[{1},zb]}];*)
