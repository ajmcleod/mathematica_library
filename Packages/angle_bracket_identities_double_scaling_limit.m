...
\[LeftAngleBracket] 1 - u, 1 - u - w \[RightAngleBracket] := -\[LeftAngleBracket] w, 1 - u \[RightAngleBracket] + \[LeftAngleBracket] w, 1 - u - w \[RightAngleBracket];
\[LeftAngleBracket] 1 - w, 1 - u - w \[RightAngleBracket] := -\[LeftAngleBracket] u, 1 - w \[RightAngleBracket] + \[LeftAngleBracket] u, 1 - u - w \[RightAngleBracket];
